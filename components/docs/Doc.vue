<template>
  <div class="py-8 max-w-full text-gray-700">
    <h2 class="text-3xl font-medium mb-10 text-white">Documentation</h2>
    <section class="mb-16 px-3 md:px-8 py-8 bg-white">
    ...
    <section class="mb-16 px-3 md:px-8 py-8 bg-white">
      ...
      <div class="mb-8">
        ...
        <div class="flex flex-wrap md:flex-nowrap pl-6 mt-6">
          ...
          <p class="pl-1">
            Contains the
            <strong class="font-medium"> sidenav-items-section</strong>
        ...
        <div class="flex flex-wrap md:flex-nowrap pl-6 mt-6">
          ...
          <p class="pl-1">
            ...
            contains the
            <span class="font-medium"> sidenav-items-section</span> and the
            <span class="font-medium"> sidenav-item</span>components
          </p>
        </div>
        <div class="flex flex-wrap mt-8 pl-8 mb-12">
          ...
          <ul class="pt-8 md:pt-0 md:pl-4 md:w-6/12">
            ...
            <li class="mb-2">
              <span class="px-1 font-medium">name :</span> name of the section
            </li>
            <li class="mb-2">
    ...
    <section class="px-3 md:px-8 py-8 bg-white">
